...
(function () {
  ...
  WardrobeScene.BUILD = { time: '06-16 07:12 UTC', note: '모바일 뷰 10% 확대(반경 4.42→3.98) · 러그 위치' };
  ...
  P._setupInteraction = function () {
    ...
    this.cam = { theta: 0, phi: _phi0, phiInit: _phi0, radius: this.isMobile ? 3.98 : 3.4, targetTheta: 0, targetPhi: _phi0 };   // 초기 상하각, 모바일은 뒤로(전경↑)+10% 확대
  ...
  P._updateCamera = function (t, dt) {
    ...
    // radius 살짝 호흡
    this.cam.radius = (this.isMobile ? 3.98 : 3.4) + Math.sin(t * 0.3) * 0.05;   // 모바일 뒤로(전경↑)+10% 확대
