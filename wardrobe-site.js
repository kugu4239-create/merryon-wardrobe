...
(function () {
  ...
  P._hangCutoutGarments = function (group, rodY, rodZ, spanW) {
    ...
    // [폴더, 파일, 종류, 개별스케일]
    var CUTS = [
      ['up', '8dbdd3289854eef87e4b7b120803db73.png', 'dress', 1.035, 0.085, 0.045],  // 블루 셔츠 원피스(#1 옷걸이 좌우 더 좁게 0.11→0.085)
  ...
  P._buildJewelryCabinet = function () {
    ...
    var g = new T.Group();
    var W = this.ROOM.W;
    g.position.set(W / 2 - 0.4, 0, 4.3); g.rotation.y = -Math.PI / 2; scene.add(g);   // 오른쪽 벽 앞-코너(창/커튼 앞쪽), 실내(-x) 향함
